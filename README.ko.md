<p align="center">
  <img src="docs/assets/readme-hero.svg" alt="Latent Space Observatory — 3D로 임베딩 공간을 탐험하세요" width="100%"/>
</p>
...
<p align="center">
  <img src="docs/assets/embedding-orbit.svg" alt="애니메이션 잠재 공간 — 개념 클러스터, 쿼리 프로브, 자동 궤도" width="560"/>
</p>

**실제 임베딩 공간을 3D로 탐험하세요 — 자체 벡터를 업로드하거나 브라우저에서 실행되는 모델로 텍스트를 실시간 임베딩합니다.**

AI 연구는 방대한 고차원 데이터 — 임베딩, 활성화, 어텐션 맵 — 를 생성하지만, 거의 모든 사람이 평면 2D 플롯으로만 봅니다. 이 도구는 임베딩 공간을 탐색 가능한 3D 세계로 렌더링하며, ParaView와 동일한 툴킷으로 구축되었습니다. **실시간** `all-MiniLM-L6-v2` 임베딩으로 바로 시작합니다. 합성 데모는 없습니다.

<p align="center">
  <img src="docs/assets/readme-status.svg" alt="브라우저에서 실시간 MiniLM 임베딩" width="100%"/>
</p>
